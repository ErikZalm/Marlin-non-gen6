  ...
  else if(code_seen('M'))
  {
    ...
    switch( (int)code_value() ) 
    {
      ...
      case 92: // M92
        ...
        break;
      case 115: // M115
        Serial.println("FIRMWARE_NAME:Marlin non gen6 FIRMWARE_URL:http://www.github.com/ErikZalm PROTOCOL_VERSION:1.0 MACHINE_TYPE:Mendel EXTRUDER_COUNT:1");
        Serial.println(uuid);
        break;
      case 114: // M114
	Serial.print("X:");
